...
- [**Manage Azure identities and governance (15-20%)**](pages/manage-azure-identities-and-governance.md/#azure-identities-and-governance)
    - [Manage Azure Active Directory (Azure AD) objects](pages/manage-azure-identities-and-governance.md/#manage-azure-active-directory-objects)
        - [create users and groups](pages/manage-azure-identitites-and-governance.md/#create-users-and-groups)
        - [create administrative units](pages/manage-azure-identitites-and-governance.md/#create-administrative-units)
        - [manage user and group properties](pages/manage-azure-identitites-and-governance.md/#manage-user-and-group-properties)
        - [manage device settings](pages/manage-azure-identitites-and-governance.md/#manage-device-settings)
        - [perform bulk user updates](pages/manage-azure-identitites-and-governance.md/#perform-bulk-user-updates)
        - [manage guest accounts](pages/manage-azure-identitites-and-governance.md/#manage-guest-accounts)
        - [configure Azure AD join](pages/manage-azure-identitites-and-governance.md/#configure-azure-ad-join)
        - [configure self-service password reset](pages/manage-azure-identities-and-governance.md/#configure-self-service-password-reset)
    - [Manage role-based access control](pages/manage-azure-identities-and-governance.md/#manage-role-based-access-control---(rbac))
        - [create a custom rule](pages/manage-azure-identities-and-governance.md//#create-a-custom-rule)
        - [provide access to Azure resources by assigning roles at different scopes](pages/manage-azure-identities-and-governance.md//#provide-access-to-azure-resources-by-assigning-roles-at-different-scopes)
        - [interpret access assignments](pages/manage-azure-identities-and-governance.md//#interpret-access-assignments)
    - [Manage subscription and governance](pages/manage-azure-identities-and-governance.md/#manage-subscription-and-governance)
        - [configure Azure policies](pages/manage-azure-identities-and-governance.md//#configure-azure-policies)
        - [configure resource locks](pages/manage-azure-identities-and-governance.md//#configure-resource-locks)
        - [apply and manage tags on resources](pages/manage-azure-identities-and-governance.md//#apply-and-manage-tags-on-resources)
        - [manage resource groups](pages/manage-azure-identities-and-governance.md//#manage-resource-groups)
        - [manage subscriptions](pages/manage-azure-identities-and-governance.md//#manage-subscriptions)
        - [manage costs](pages/manage-azure-identities-and-governance.md//#manage-costs)
        - [configure management](pages/manage-azure-identities-and-governance.md//#configure-management-groups)
...
- [**Monitor and back up Azure Resources (10-15%)**](pages/monitor-and-back-up-azure-resources.md/#monitor-and-back-up-azure-resources)
    - [Monitor resources by using Azure Monitor](pages/monitor-and-back-up-azure-resources.md/#monitor-resources-by-using-azure-monitor)
        - [configure and interpret metrics](pages/monitor-and-back-up-azure-resources.md/#configure-and-interpret-metrics)
        - [configure Azure Monitor logs](pages/monitor-and-back-up-azure-resources.md/#configure-azure-monitor-logs)
        - [query and analyze logs](pages/monitor-and-back-up-azure-resources.md/#query-and-analyze-logs)
        - [set up alerts and actions](pages/monitor-and-back-up-azure-resources.md/#set-up-alerts-and-actions)
        - [configure Application Insights](pages/monitor-and-back-up-azure-resources.md/#configure-application-insights)
    - [Implement backup and recovery](pages/monitor-and-back-up-azure-resources.md/#implement-backup-and-recovery)
        - [create a Recovery Services vault](pages/monitor-and-back-up-azure-resources.md/#create-a-recovery-services-vault)
        - [create and configure backup policy](pages/monitor-and-back-up-azure-resources.md/#create-and-configure-backup-policy)
        - [perform backup and restore operations by using Azure Backup](pages/monitor-and-back-up-azure-resources.md/#create-and-configure-backup-policy)
        - [perform site-to-site recovery by using Azure Site Recovery](pages/monitor-and-back-up-azure-resources.md/#perform-site-to-site-recovery-by-using-azure-site-recovery)
        - [configure and review backup reports](pages/monitor-and-back-up-azure-resources.md/#configure-and-review-backup-reports)